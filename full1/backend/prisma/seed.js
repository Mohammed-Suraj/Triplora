...
const categories = ['Hill Station', 'Backwaters', 'Beach', 'Heritage', 'Wildlife', 'Waterfall'];
...
const destinations = [
    {
        ...
        duration: '2-3 days',
        bestSeason: 'Sep - May',
        description: 'A hill station draped in endless tea plantations, misty valleys and cool mountain air at 1,600 metres above sea level.',
        longDescription: "Munnar is Kerala's most beloved hill station, where emerald tea gardens roll across the Western Ghats as far as the eye can see. Once the summer resort of the British Raj, it remains a sanctuary of cool air, winding mountain roads and mist that drifts through the valleys each morning. Visit the Tea Museum, trek to Anamudi \u2014 South India's highest peak \u2014 or simply watch the light change over the plantations from a hilltop cottage.",
    ...
    },
    {
        ...
        duration: '1-2 days',
        bestSeason: 'Nov - Feb',
        description: 'Drift along serene backwaters aboard a traditional kettuvallam houseboat through a maze of canals, lagoons and paddy fields.',
...
async function main() {
    ...
    const passwordHash = await bcrypt_1.default.hash('Password@123', 12);
